...
public class RabbitConfig {
    ...
    public void createQueues() {
        amqpAdmin.declareQueue(new Queue("person.create", true));
        amqpAdmin.declareQueue(new Queue("solution.sent", true));
        amqpAdmin.declareQueue(new Queue("solution.review", true));
    }
}